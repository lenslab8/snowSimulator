...
#
#     axis[4].set_title('Data')
#     axis[4].plot(np.arange(len(subCarrierBinary40ByteDataList[0][0])), subCarrierBinary40ByteDataList[0][0])
#     axis[4].set_xlabel('Bits')
...
for i in range(len(compositeSignal)):
    ...
    util.fftRevised(compositeSignal, fs)
